...
export const createSunglass = async (req, res, next) => {
...
export const updateSunglass = async (req, res, next) => {
    try {
...
export const updateSunglassStock = async (req, res, next) => {
    try {
        const SunglassId = req.params.id;
...
//get all sunglass
export const getAllSunglass = async (req, res, next) => {
    try {
...
//get Sunglass by id
export const getSunglassById = async (req, res, next) => {
    try {
        const SunglassId = req.params.id;
        if (!SunglassId) {
            console.warn("No Sunglass ID provided");
...
//delete Sunglass
export const deleteSunglass = async (req, res, next) => {
    try {
