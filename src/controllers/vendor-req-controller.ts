...
export const createVendorRequest = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const getAllVendorRequest = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const deleteVendorReq = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const getVendorReq = async (req: Request, res: Response, next: NextFunction) => {
    try {
        const reqID = req.params.id;
